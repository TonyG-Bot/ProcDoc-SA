...
local function initializeLocalization()
		...
		if locale == "esES" then
			-- TurtleWoW SA esES
			localizedBuffName = {
				["Shadow Trance"] = "Trance Sombrío",
				["Shadow Veil"] = "Shadow Veil", -- No encontre traduccion en Spell.dbc
				["Spell Blasting"] = "Explosión Mágica",
				["Clearcasting"] = "Lanzamiento Claro",
				["Netherwind Focus"] = "Enfoque del Viento del Vacío",
				["Temporal Convergence"] = "Convergencia Temporal",
				["Flash Freeze"] = "Congelación Relámpago",
				...
				["Hammer of Wrath"] = "Martillo de Ira",
				["Temporal Convergence"] = "Convergencia Temporal",
				["Hot Streak"] = "Racha Caliente",
				["hot streak"] = "racha caliente",
				["Tricks of the Trade"] = "Trucos del Oficio",
				["Lacerate"] = "Lacerar",
				["Baited Shot"] = "Baited Shot", -- No encontre traduccion en Spell.dbc
			}
		else
			--enUS
			localizedBuffName = {
    ...
    for i = 0, 31 do
        ...
        if buffTexture then
            ...
            if buffName ~= "" then
                ...
                if lowerName == string.lower(HOT_STREAK_BUFF_NAME) or string.find(lowerName, localizedBuffName["hot streak"]) then
                    local apiStacks
